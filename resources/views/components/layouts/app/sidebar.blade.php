...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <flux:navlist variant="outline">
        <flux:navlist.group :heading="__('Platform')" class="grid">
            ...
            <!-- [PENAMBAHAN MENU ASET DIMULAI DI SINI] -->
            ...
            <flux:navlist.item
                ...
                :href="route('asset_categories.index')"
                :current="request()->routeIs('asset_categories.*')"
                wire:navigate
            >
                {{ __('Jenis Aset') }}
            </flux:navlist.item>
        ...
        <flux:dropdown class="hidden lg:block" position="bottom" align="start">
            ...
            <flux:menu class="w-[220px]">
                ...
                <flux:menu.separator />
                <flux:menu.radio.group>
                    <flux:menu.item :href="route('my-profile')" icon="user-circle" wire:navigate>Profil Saya</flux:menu.item>
        ...
        <flux:header class="lg:hidden">
            ...
            <flux:dropdown position="top" align="end">
                ...
                <flux:menu>
                    ...
                    <flux:menu.separator />
                    <flux:menu.radio.group>
                        {{-- [PERUBAHAN 2] Link Profil Saya ditambahkan di sini juga --}}
                        <flux:menu.item :href="route('my-profile')" icon="user-circle" wire:navigate>Profil Saya</flux:menu.item>
                        <flux:menu.item :href="route('profile.edit')" icon="cog" wire:navigate>{{ __('Settings') }}</flux:menu.item>
                    </flux:menu.radio.group>
                    <flux:menu.separator />
